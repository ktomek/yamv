...
import com.ktomek.yamv.koin.counter.logic.outcome.AutoDecreaseCounterOutcome
...
class AutoDecreaseFeature : FlowFeature<CounterState> {
    ...
    override fun invoke(intentions: Flow<Any>): Flow<CounterOutcome> =
        intentions
            ...
            .flatMapMerge {
                autoDecreaseFlow()
                    .takeUntilSignal(intentions.filter { it is StopAutoDecreaseCounterIntention })
